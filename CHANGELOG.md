...
- 1.21 and above only.
- Fixed a bug where `CobwebEntry`s wouldn't properly check whether a `Holder` matched.

## [v1.3.2] - 2025/02/12

- 1.21 and above only.
- Fixed mappings when importing Cobweb in a Fabric-Yarn development environment.
