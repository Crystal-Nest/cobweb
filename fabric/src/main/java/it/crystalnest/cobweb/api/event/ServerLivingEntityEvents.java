package it.crystalnest.cobweb.api.event;
...
public final class ServerLivingEntityEvents {
   ...
   * This is fired from {@link LivingEntity#hurt(DamageSource, float)}, before armor or any other mitigation are applied.
  ...
  static {
    ...
    ServerLivingEntityEvents.ALLOW_DEATH.register((entity, damageSource, damageAmount) -> !(entity instanceof ServerPlayer player) || ServerPlayerEvents.ALLOW_DEATH.invoker().allowDeath(player, damageSource, damageAmount));
  }
